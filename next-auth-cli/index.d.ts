 ...
 */
export default function nextAuthCli(config: import("typeorm").ConnectionOptions | string, models?: string | import("./types").Models | undefined, log?: ((...args: any) => any) | undefined): Promise<void>;
